...
# 参数来自 Step4 盆地实测：alpha_mean 0.696, decay_mean 0.869
# determinism-check 3，3-seed 验收
...
if [ "$SEED" = "all" ]; then
  for s in 42 123 777; do
    echo "=== Step5 Freeze (determinism=3) seed $s ==="
    python3 tools/run_d1_tournament.py \
      ...
      --out-dir outputs/d1_runs/phase3_step5_freeze --mode recompute \
