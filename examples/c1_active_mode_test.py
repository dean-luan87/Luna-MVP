#!/usr/bin/env python3
"""
C1 Active Mode v0.1 测试脚本

测试 C1 Active Mode 的控制能力（仅控制 ModelingExecutor）。

运行方式：
    python examples/c1_active_mode_test.py
"""
...
def main():
    ...
    for i, (motion_score, frame_diff, scene_class) in enumerate(simulate_scenarios()):
        ...
        # Shadow Mode 观察（用于对比）
        shadow_decisions = shadow_controller.observe(
