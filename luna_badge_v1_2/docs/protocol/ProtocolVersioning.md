...
- **MAJOR**: 不兼容的协议变更（字段移除、格式调整）
- **MINOR**: 向后兼容的新功能（新增可选字段）
- **PATCH**: 向后兼容的 bug 修复
...
```json
{
  "type": "warning",
  "code": "PROTO-001",
  "message": "您的协议版本 0.9.0 已过时。请升级到 1.0.0。",
...
- 初始版本
- 定义所有核心规范（FrameSpec, InferSpec, HeartbeatSpec, PerfLogSpec, HeatDecaySpec, EventBus, ErrorSpec）

---

## 📚 相关规范

- [FrameSpec.md](./FrameSpec.md) - 帧数据规范
- [InferSpec.md](./InferSpec.md) - 推理结果规范
- [HeartbeatSpec.md](./HeartbeatSpec.md) - 心跳规范
- [ErrorSpec.md](./ErrorSpec.md) - 错误码规范（PROTO-001）
