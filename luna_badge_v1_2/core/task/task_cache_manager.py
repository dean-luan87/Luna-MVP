...
class TaskCacheManager:
    ...
    def save(self, engine, map_manager=None):
        ...
        try:
            ...
            print(f"[TaskCacheManager] Saved state to {self.cache_file}")
        except Exception as e:
            print(f"[TaskCacheManager] Failed to save: {e}")
    ...
    def load(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            with open(self.cache_file, "r", encoding="utf-8") as f:
                data = json.load(f)
            print(f"[TaskCacheManager] Loaded state from {self.cache_file}")
            return data
        except Exception as e:
            print(f"[TaskCacheManager] Failed to load: {e}")
            return None
    ...
    def clear(self):
        ...
        try:
            if os.path.exists(self.cache_file):
                ...
                print(f"[TaskCacheManager] Cleared cache file")
        except Exception as e:
            print(f"[TaskCacheManager] Failed to clear: {e}")
