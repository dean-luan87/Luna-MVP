...
def test_vision_modules_direct():
    ...
    from capabilities.vision.camera_router import CameraRouter
    from capabilities.vision.vision_scheduler import VisionScheduler, SchedulerContext
    from capabilities.vision.vision_fail_safe import VisionFailSafe
...
def test_task_modules_direct():
    ...
    # 直接导入文件，不通过 __init__.py
    from decision.task_chain.task_transition_manager import (
    ...
    from decision.task_chain.query_bus import QueryBus, QueryStatus
