...
将 Step 1-7 的 Check List 转化为可执行的自动化验收脚本，防止代码走样。

## 使用方法

```bash
# 基本用法（只检查代码）
python vision_pipeline/b2/v03/validation/b2_v05_validation.py vision_pipeline/b2/v03/b2_v03.py
...
```yaml
# .github/workflows/b2_validation.yml
- name: Validate B2 v0.5
  run: |
    python vision_pipeline/b2/v03/validation/b2_v05_validation.py \
      vision_pipeline/b2/v03/b2_v03.py \
      traces/b2_runtime_trace_v05.jsonl
